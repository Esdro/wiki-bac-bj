 ...
 */
final class Version20251121165004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE forum_categories ALTER id TYPE UUID');
        $this->addSql('ALTER TABLE forum_categories ALTER id DROP DEFAULT');
        $this->addSql('ALTER TABLE forum_categories ALTER parent_id TYPE UUID');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE forum_categories ALTER id TYPE INT');
        $this->addSql('ALTER TABLE forum_categories ALTER id SET DEFAULT nextval(\'forum_categories_id_seq\'::regclass)');
        $this->addSql('ALTER TABLE forum_categories ALTER parent_id TYPE INT');
